...
$GLOBALS['TL_DCA']['tl_content']['palettes']['project_detail'] = '{type_legend},type,headline,title;{image_legend},size;{template_legend:hide},customTpl,project_template;{testimonial_legend},testimonial_template;{protected_legend:hide},protected;{expert_legend:hide},cssID;{invisible_legend:hide},invisible,start,stop';
